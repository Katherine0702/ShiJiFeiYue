...
public class PreferenceUtil {
	...
	public static String prefName = "zhifu";
    /**
     * 由数据的key得到单个用户字符串数据
     *
    ...
    public static void clearLoginAll(Context context){
        ...
        PreferenceUtil.putString(context, "zhifubaoAccountNo", "");
        PreferenceUtil.putString(context, "zhifubaoProviderId", "");
        PreferenceUtil.putString(context, "weixinAccountNo", "");
        PreferenceUtil.putString(context, "weixinProviderId", "");
    }
}
