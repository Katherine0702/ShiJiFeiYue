...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<String> imageUrlList, ArrayList<String> imageTitle, ImageCycleViewListener imageCycleViewListener, int stype, boolean isLocalDrawable) {
        this.stype = stype;
        ...
        if (imageCount > 1) {
            for (int i = 0; i < imageCount; i++) {
                ...
                LayoutParams params = new LayoutParams(DisplayUtil.dip2px(mContext, 6), DisplayUtil.dip2px(mContext, 6));
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mAdList.size() > 0) {
                ...
                title = mATitle.get(position % mATitle.size());
            }
            ...
            if (isLocalDrawable) {
                ...
                xUtilsImageUtils.display(imageView, R.mipmap.ic_error, imageUrl);
            }
