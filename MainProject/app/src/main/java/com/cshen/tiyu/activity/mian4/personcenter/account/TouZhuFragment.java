...
public class TouZhuFragment extends Fragment {
	...
	private void initdata() {
		...
		ServiceUser.getInstance().PostDetailAccount(getActivity(),"10", "0", userId, userPwd, "1",
			...
			public void onFailure(ErrorMsg errorMessage) {
				...
				if(errorMessage!=null
					...
					ToastUtils.showShort(TouZhuFragment.this.getActivity(),errorMessage.msg);						
				}
				nodata.setVisibility(View.VISIBLE);
				refreshListView.setVisibility(View.GONE);
			}
