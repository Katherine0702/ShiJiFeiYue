...
public class SDEL11to5PeriodsActivity extends BaseActivity {
	private RefreshListView refreshList_sdel11to5;
	private SDEL11to5PeriodsActivity _this;
	...
	private void initView() {
		...
		refreshList_sdel11to5.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (data!=null) {
					Intent intent=new Intent(SDEL11to5PeriodsActivity.this,SDEL11to5PeriodDetailActivity.class);
	...
	private void initHead() {
		...
		if ("14".equals(lottery)) {
			tv_head_title.setText("山东11选5");
		}
		if ("19".equals(lottery)) {
			tv_head_title.setText("广东11选5");
		}
		...
		tvTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = null;
				if ("14".equals(lottery)) {
					intent = new Intent(SDEL11to5PeriodsActivity.this,
		...
		backImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO 自动生成的方法存根
//				Intent intent = new Intent(SDEL11to5PeriodsActivity.this,
//						MainActivity.class);
//				startActivity(intent);
	...
	class HelpAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.textview_result_sdel11to504 = (TextView) convertView
						.findViewById(R.id.textview_result_sdel11to504);
				holder.textview_result_sdel11to505 = (TextView) convertView
						.findViewById(R.id.textview_result_sdel11to505);
			...
			if (data != null) {
				...
				if (data.getResult() != null) {
					...
					holder.textview_result_sdel11to504.setText(Util
							.periodNumberFromat(resultNumber[3]));
					holder.textview_result_sdel11to505.setText(Util
					 ...
					 holder.textview_result_sdel11to504.setBackgroundDrawable(getResources().getDrawable(R.drawable.chooseballred));
					 holder.textview_result_sdel11to504.setTextColor(Color.WHITE);
					 holder.textview_result_sdel11to504.setPadding(left_right_Pix,top_bottom_Pix,left_right_Pix,top_bottom_Pix);
					 holder.textview_result_sdel11to505.setBackgroundDrawable(getResources().getDrawable(R.drawable.chooseballred));
					 holder.textview_result_sdel11to505.setTextColor(Color.WHITE);
					 holder.textview_result_sdel11to505.setPadding(left_right_Pix,top_bottom_Pix,left_right_Pix,top_bottom_Pix);
						 ...
						 holder.textview_result_sdel11to504.setBackgroundDrawable(null);
						 holder.textview_result_sdel11to504.setTextColor(getResources().getColor(R.color.mainred));
						 holder.textview_result_sdel11to505.setBackgroundDrawable(null);
						 holder.textview_result_sdel11to505.setTextColor(getResources().getColor(R.color.mainred));
		...
		class ViewHolder {
			...
			public TextView textview_result_sdel11to504;
			public TextView textview_result_sdel11to505;
