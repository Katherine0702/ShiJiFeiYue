...
public class FindGridAdapter extends BaseAdapter {
	...
	public FindGridAdapter(ArrayList<FindBean> mDataList, Context mContext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view = null;
		view = View.inflate(mContext, R.layout.grid_lotterytype_item_find, null);
	...
	if (dataBean != null) {
			...
			xUtilsImageUtils.display(imageView, errorResId, dataBean.getIcon());
