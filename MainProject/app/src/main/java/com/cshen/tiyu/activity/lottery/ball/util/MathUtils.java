...
import com.cshen.tiyu.activity.lottery.ball.domain.CombCallBack;
import com.cshen.tiyu.activity.lottery.ball.domain.ExtensionCombCallBack;
...
public final class MathUtils {
	 ...
	 * @param callBack 回调函数
	 * @see com.cshen.tiyu.activity.lottery.ball.domain.ball.cai310.utils.ExtensionCombCallBack#run(boolean[], int, boolean[],
	 *      int)
	 */
