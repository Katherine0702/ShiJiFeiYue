...
public class SSQPeriodsActivity extends BaseActivity {
	private RefreshListView refreshList_ssq;
	private SSQPeriodsActivity _this;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_periods_ssq);
		_this = this;
		initHead();

		initView();
		initAllDataForList();
		refreshList_ssq.getItemAtPosition(0);

	}

	private void initView() {
		refreshList_ssq = (RefreshListView) findViewById(R.id.refreshList_ssq);
		dltAdapter = new DltAdapter();
		refreshList_ssq.setAdapter(dltAdapter);
		refreshList_ssq.setOnRefreshListener(new OnRefreshListener() {
			...
			private void requestDataFromServer(boolean isLoadingMore) {
				if (isLoadingMore) {
					more++;
					start = more * step;
					ServiceCaiZhongInformation.getInstance().pastPrizeList(_this,"0",
							start + "", step + "","",
							new CallBack<PrizeList>() {
								...
								public void onFailure(ErrorMsg errorMessage) {
									...
									refreshList_ssq.onRefreshComplete(false);
								}
		...
		refreshList_ssq.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (data!=null) {
					Intent intent=new Intent(SSQPeriodsActivity.this,SSQPeriodDetailActivity.class);
	...
	protected void initAllDataForList() {
		...
		ServiceCaiZhongInformation.getInstance().pastPrizeList(_this,"0", more + "", step + "","",
				new CallBack<PrizeList>() {
					@Override
					public void onFailure(ErrorMsg errorMessage) {
	...
	private void initHead() {
		...
		tvTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO 自动生成的方法存根
				Intent intent = new Intent(SSQPeriodsActivity.this,
...
//		startActivity(intent);
	...
	class DltAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ViewHolder holder;
			if (convertView == null) {
				convertView = View.inflate(_this, R.layout.ssq_period_item,
						null);
			...
			if (data != null) {
				...
				if (data.getResult() != null) {
					...
					holder.textview_result_dlt07.setText(Util
					 ...
					 holder.textview_result_dlt06.setBackgroundDrawable(getResources().getDrawable(R.drawable.chooseballred));
					 ...
					 holder.textview_result_dlt07.setPadding(left_right_Pix,top_bottom_Pix,left_right_Pix,top_bottom_Pix);
						 ...
						 holder.textview_result_dlt06.setTextColor(getResources().getColor(R.color.mainred));
