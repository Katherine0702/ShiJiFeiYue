...
public class Main115Activity  extends BaseActivity  implements OnClickListener,SensorEventListener  {
	public static  int WANFAINT = ConstantsBase.RENXUAN2;
	public static  int DANTUO = 1;
	public static  int NUMLEAST = 2;
	public static  int NUMMOST = 0;
	private Main115Activity _this;
	...
	public void initView(){
		...
		((TextView) findViewById(R.id.tv_head_title)).setText("山东11选5—");
	...
	private void initHistroyDataForCathectic(){
		...
		ServiceCaiZhongInformation.getInstance().pastPrizeList(_this,ConstantsBase.SD115+"","0",10+"",missType,new CallBack<PrizeList>() {
			@Override
	...
	private void initDataForCathectic() {
		// TODO 自动生成的方法存根
		ServiceUser.getInstance().PostPeriod(_this,ConstantsBase.SD115+"", new CallBack<PeriodResultData>() {
			@Override
	...
	private void initKaijiangDataForCathectic() {
		ServiceCaiZhongInformation.getInstance().pastNowPrize(_this,ConstantsBase.SD115+"",new CallBack<NowPrize>() {
			@Override
			public void onFailure(ErrorMsg errorMessage) {
				// TODO Auto-generated method stub	
				if(errorMessage!=null
	...
	public void setView(){
		...
		if(DANTUO == 1){
			...
			String leastStr = "<html><font color=\"#666666\">至少选择"
					+"</font><font color=\"#ec3634\">"+NUMLEAST+"个"
				...
				if(WANFAINT == ConstantsBase.ZHIXUAN1){
					...
					if(NUMLEAST>=5){
						maymoneyStr = "<html><font color=\"#666666\">猜对任意5个号码即中"
								+"</font><font color=\"#ec3634\">"+mayMoney+"元"
								+ "</font></html>";
					}else{
		...
		if(DANTUO == 0){//胆拖
			...
			if(NUMMOST == 1){
				...
				danmatitleStr=  "<html><font color=\"#666666\">请选择"
						...
						+"</font><font color=\"#ec3634\">"+NUMMOST+"个"
						+"</font><font color=\"#666666\">号码"
						+ "</font></html>";
			}
	...
	public void sure(){
		if(number115 == null
			...
			if(position == -1){
				Intent intent = new Intent(_this, Account115ListActivity.class);
