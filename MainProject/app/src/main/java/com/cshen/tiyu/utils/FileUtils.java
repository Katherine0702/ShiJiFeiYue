...
public class FileUtils {
	...
	/**
	 * 打开文件 syao 2015-06-26 补充
	 * 
	 * @param file
	 */
	public static void openFile(File file, Context cc)
	{
		...
		try
		{
			...
			cc.startActivity(intent); // 这里最好try一下，有可能会报错。
			// //比如说你的MIME类型是打开邮箱，但是你手机里面没装邮箱客户端，就会报错。
		}
		catch (Exception e)
		{

			Toast.makeText(cc, "您的手机无法打开此类文件！", Toast.LENGTH_SHORT).show();
		}
		finally
		{
