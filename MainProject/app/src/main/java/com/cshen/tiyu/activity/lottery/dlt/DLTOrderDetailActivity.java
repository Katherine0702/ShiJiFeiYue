...
public class DLTOrderDetailActivity extends OrderDetailActivity {
	...
	textview_result_n06,textview_result_n07;
	...
	private void initView() {
		...
		textview_result_n06 = (TextView) findViewById(R.id.textview_result_n06);
	...
	public void setData(String result,String state){
		...
		if (!TextUtils.isEmpty(result)) {
			...
			try {
				textview_result_n01.setText(Util
						.periodNumberFromat(resultNumber[0]));
				textview_result_n02.setText(Util
						.periodNumberFromat(resultNumber[1]));
				textview_result_n03.setText(Util
						.periodNumberFromat(resultNumber[2]));
				textview_result_n04.setText(Util
						.periodNumberFromat(resultNumber[3]));
				textview_result_n05.setText(Util
						.periodNumberFromat(resultNumber[4]));
				textview_result_n06.setText(Util
						.periodNumberFromat(resultNumber[5]));
				textview_result_n07.setText(Util
