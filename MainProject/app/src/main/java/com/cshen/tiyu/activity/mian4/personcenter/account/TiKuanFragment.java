...
public class TiKuanFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initView();// 初使化控件
		//ToastUtils.showShort(getActivity(), "成功获取drawing数据");
	...
	private void initdata() {
		...
		ServiceUser.getInstance().PostDetailAccount(getActivity(),"10", "0", userId, userPwd, "2",
			...
			public void onFailure(ErrorMsg errorMessage) {
				...
				if(errorMessage!=null
					...
					ToastUtils.showShort(TiKuanFragment.this.getActivity(),errorMessage.msg);						
				}
				nodata.setVisibility(View.VISIBLE);
				refreshListView.setVisibility(View.GONE);
			}
	...
	protected void setDateForList() {
		...
		//ListViewLayoutUtils.setListViewHeightBasedOnChildren(listView);
		// 添加监听器
